...
# sphinx-quickstart on Wed Oct 21 09:20:18 2015.
#
...
import imp
muda_version = imp.load_source('muda.version', '../muda/version.py')
version = muda_version.version
# The full version, including alpha/beta/rc tags.
release = muda_version.version
...
latex_documents = [
  ('index', 'muda.tex', u'muda Documentation',
...
man_pages = [
    ('index', 'muda', u'muda Documentation',
     [u'Brian McFee'], 1)
]
...
texinfo_documents = [
  ('index', 'muda', u'muda Documentation',
   u'Brian McFee', 'muda', 'One line description of project.',
   'Miscellaneous'),
]
